...
export namespace Prisma {
  ...
  */
  ...
  export type PointGetPayload<S extends boolean | null | undefined | PointArgs> =
    ...
    P extends keyof Point ? Point[P] : never
  } 
      : Point
  ...
  export interface PointDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): Prisma.PrismaPromise<Array<PointGetPayload<T>>>
   ...
   */
  export class Prisma__PointClient<T, Null = never> implements Prisma.PrismaPromise<T> {
   ...
   */
  export type PointFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Point
     */
    select?: PointSelect | null
   ...
   */
  export type PointFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Point
     */
    select?: PointSelect | null
